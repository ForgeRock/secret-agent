...
func (in *AppConfig) DeepCopyInto(out *AppConfig) {
	*out = *in
	if in.SecretTimeout != nil {
		in, out := &in.SecretTimeout, &out.SecretTimeout
		*out = new(int)
		**out = **in
	}
...
func (in *SecretAgentConfigurationStatus) DeepCopyInto(out *SecretAgentConfigurationStatus) {
	*out = *in
	if in.ManagedKubeSecrets != nil {
		in, out := &in.ManagedKubeSecrets, &out.ManagedKubeSecrets
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.ManagedSecretManagerSecrets != nil {
		in, out := &in.ManagedSecretManagerSecrets, &out.ManagedSecretManagerSecrets
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
